...
struct document get_document(char* text) {
    ...
    while(pch1 != NULL)	{
		if(npara = 0)	{
			...
			document1->data[npara] = realloc(document1.data[npara], 
                                                        sizeof(struct paragraph) * (npara + 1));
        ...
        while(pch2 != NULL)	{
			if(nsent == 0)	{
				...
				document1.data[npara].data[nsent] = realloc(document1.data[npara].data[nsent], 
                                                                            sizeof(struct sentence) * (nsent + 1));
            ...
            while(pch3 != NULL)    {
				if(nword == 0)	{
					...
					document1.data[npara].data[nsent].data[nword] = realloc(document1.data[npara].data[nsent].data[nword], 
                                                                                                sizeof(struct(word)) * (nword + 1));
